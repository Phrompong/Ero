                        ...
                        >
                            <div className="content-detail-share">
                                ...
                                <div className="text-amount right">
                                    <p>จำนวน</p>
                                    <b className="text-black">{formatNumber(stockVolume)}</b>
                                    <p>หุ้น</p>
                                </div>
                            </div>
                            <div className="content-detail-share">
                                <div className="text-title">
                                    ...
                                    <p className="text-black">{formatNumber(offerPrice)} บาท</p>
                                </div>
                            ...
                            <div className="content-detail-share">
                                ...
                                <div className="text-amount right">
                                    <p>จำนวน</p>
                                    <b className="text-black">{formatNumber(rightStockVolume)}</b>
                                    <p>หุ้น</p>
                                </div>
                            </div>
                            <div className="content-detail-share">
                            ...
                            <>
                                ...
                                <div className="content-member">
                                    <div className="content-detail-member">
                                        ...
                                        <div className="content-detail-text right" style={{ marginTop: "auto", marginBottom: "auto" }}>
                                            <p>เลขที่บัญชี :</p>
